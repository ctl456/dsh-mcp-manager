window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = ".Q8bH4q_card{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);border-radius:10px;padding:14px 16px;list-style:none}.Q8bH4q_header{flex-direction:column;gap:2px;display:flex}.Q8bH4q_name{font-weight:600}.Q8bH4q_description{opacity:.7;font-size:12px}.Q8bH4q_body{flex-direction:column;gap:16px;margin-top:12px;display:flex}.Q8bH4q_notice{opacity:.8;margin:0;font-size:12px}.Q8bH4q_section{flex-direction:column;gap:10px;display:flex}.Q8bH4q_sectionTitle{margin:0;font-size:13px;font-weight:600}.Q8bH4q_empty{opacity:.7;margin:0;font-size:12px}.Q8bH4q_list{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.Q8bH4q_server{border:1px solid var(--dsw-alias-border-l1);border-radius:8px;justify-content:space-between;align-items:center;gap:12px;padding:8px 10px;display:flex}.Q8bH4q_serverText{flex-direction:column;min-width:0;display:flex}.Q8bH4q_serverName{font-size:13px;font-weight:600}.Q8bH4q_serverTarget{opacity:.7;text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.Q8bH4q_serverActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.Q8bH4q_badgeOn,.Q8bH4q_badgeOff{border:1px solid;border-radius:999px;padding:1px 8px;font-size:11px}.Q8bH4q_badgeOn{opacity:1}.Q8bH4q_badgeOff{opacity:.55}.Q8bH4q_field{flex-direction:column;gap:4px;display:flex}.Q8bH4q_label{font-size:12px;font-weight:600}.Q8bH4q_input,.Q8bH4q_textarea{box-sizing:border-box;width:100%;font:inherit;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);color:inherit;resize:vertical;border-radius:6px;padding:6px 8px;font-size:13px}.Q8bH4q_hint{opacity:.65;white-space:pre-line;font-size:11px}.Q8bH4q_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.Q8bH4q_actions{gap:8px;display:flex}.Q8bH4q_button,.Q8bH4q_primary,.Q8bH4q_danger{font:inherit;border:1px solid var(--dsw-alias-border-l1);color:inherit;cursor:pointer;background:0 0;border-radius:6px;padding:5px 12px;font-size:12px}.Q8bH4q_primary{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground);border-color:#0000}.Q8bH4q_primary:hover:not(:disabled){background:var(--dsw-alias-button-primary-hover)}.Q8bH4q_danger{color:var(--dsw-alias-state-error-primary)}.Q8bH4q_button:disabled,.Q8bH4q_primary:disabled,.Q8bH4q_danger:disabled{opacity:.5;cursor:not-allowed}";
		...
		var McpManagerCard_module_css_default = {
			...
			"section": "Q8bH4q_section",
			"sectionTitle": "Q8bH4q_sectionTitle",
		...
		*/
		function McpManagerCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				className: McpManagerCard_module_css_default.card,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: McpManagerCard_module_css_default.header,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: McpManagerCard_module_css_default.name,
						children: t("title")
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					className: McpManagerCard_module_css_default.body,
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							className: McpManagerCard_module_css_default.section,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
								className: McpManagerCard_module_css_default.sectionTitle,
								children: t("servers")
								...
								children: state.servers.map((server) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
