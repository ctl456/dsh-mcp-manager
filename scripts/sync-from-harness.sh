...
upstream_package="$harness/packages/mcp/mcp-manager"
...
node scripts/set-package-name.mjs "$name" --from "@deepseek-ai/dsh-mcp-manager"
...
- Built from: \`deepseek-ai/deepseek-harness\` \`packages/mcp/mcp-manager\`
